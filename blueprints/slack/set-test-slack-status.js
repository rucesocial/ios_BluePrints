...
const headers = {
    "Authorization": "Ruce Social " + Blueprint.userAuthentification.accessToken,
    "Content-Type": "application/json;charset=UTF-8",
};

// Set status_text input
let statusText = Blueprint.newInput("status_text", "Your Status Text", "text")

// Set status_emoji select input
let statusEmoji = Blueprint.newInput("status_emoji", "Your Status Emoji (select)", "select")
